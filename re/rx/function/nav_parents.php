    ...
    function rxNavParent($step)
    {
        ...
        if ($map === null) {
            $map = [
                ...
                'hooshpay_callback_url'    => 'gw_hooshpay',
                'hooshpay_return_url'      => 'gw_hooshpay',
                'minbalancehooshpay'        => 'gw_hooshpay',
                'maxbalancehooshpay'        => 'gw_hooshpay',
                'chashbackhooshpay'         => 'gw_hooshpay',
